#!/usr/bin/env bash
# Collect git metadata for work summaries.
# Outputs key=value pairs, one per line. Missing fields are omitted.
# Usage: get-metadata.sh [directory]
#   directory: path to check (default: current directory)
