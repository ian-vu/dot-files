...
- **Documentation:** when adding or modifying code or configuration, include a brief comment explaining *why* the change exists — especially for workarounds, non-obvious behaviour, or integration-specific logic.
