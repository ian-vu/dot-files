...
# ELIXIR
SPACESHIP_ELIXIR_SHOW="${SPACESHIP_ELIXIR_SHOW:=false}"
...
# HASKELL
SPACESHIP_HASKELL_SHOW="${SPACESHIP_HASKELL_SHOW:=false}"
...
# DOTNET
SPACESHIP_DOTNET_SHOW="${SPACESHIP_DOTNET_SHOW:=false}"
...
# EMBER
SPACESHIP_EMBER_SHOW="${SPACESHIP_EMBER_SHOW:=false}"
...
# JOBS
SPACESHIP_JOBS_SHOW="${SPACESHIP_JOBS_SHOW:=false}"
